...
const signUp = () => {
  return (
    <div className="flex items-center justify-center bg-black/50 min-h-[60vh] p-10">
      <Form className="w-full max-w-110  bg-[#30302E] p-6 rounded-2xl">
        <Fieldset>
          <Fieldset.Legend className="text-white text-2xl text-center">
